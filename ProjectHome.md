It uses some file-wide [string-replacing magic](http://blogs.msdn.com/rextang/archive/2009/07/06/9819189.aspx) to convert vs2010 project/solution files back to vs2008 ones.
